...
export default function HomePage() {
  ...
  // Fixed ABI to match your contract's mintCircle function
  ...
  useEffect(() => {
    if (!process.env.NEXT_PUBLIC_WEB3_STORAGE_TOKEN) {
      console.warn('Web3.Storage token not configured. Minting will fail.');
    }
  }, []);
  ...
  const handleMint = async () => {
    ...
    try {
        ...
        // Generate image from the circle
        ...
        const { request } = await publicClient.simulateContract({
            ...
            abi: contractAbi,
            functionName: 'mintCircle', // Updated to match your contract
            args: [metadataUrl], 
            account: address,
        });
